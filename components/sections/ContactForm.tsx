...
export function ContactForm() {
  ...
  return (
    <form className="contact-form" onSubmit={submit} noValidate>
      ...
      <div className="form-field"><label htmlFor="subject">Keperluan</label><select id="subject" name="subject"><option>Informasi program</option><option>Pendaftaran peserta didik</option><option>Kunjungan</option><option>Lainnya</option></select></div>
